        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="pt-12">
            <img
              ...
              alt={gallery?.[0]?.alt || 'Detalle arquitectonico interior'}
              src={
                gallery?.[0]?.src ||
                'https://lh3.googleusercontent.com/aida-public/AB6AXuDNjaQczAc8lH4px7FX8W57KbG-eOP0taWxMhoD_aejBVQ6m4YU_u-u_WV7X9fpcmxVispVlwSVOQqcvOCbK2qLOWaf9H53PxrDNuH7OV-0zt464gg7DRj9DfB8zejvA8s7wg3zc1lmQgXahboVsBX9-hdtSM8kFZaYA44g7xE9eKGbfHO1_ylBdai61gYtXVeyH27S0Wxzww1shSJhfAGsdSwjZ1sG277qdTNPxdigq5IkiG-im3ukXmLVBJ5vnjI427P4rmHT1KLA'
              }
            />
          </div>
          <div>
