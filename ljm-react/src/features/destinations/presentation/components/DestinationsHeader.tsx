  ...
  return (
    <div className="bg-[#0e1a34]">
      <header className="pt-40 pb-16 text-center px-4">
        <h2 className="text-[#c9a962] uppercase tracking-[0.3em] text-sm mb-4 font-semibold">Descubre el Mundo</h2>
        <h1 className="font-serif italic text-4xl md:text-6xl text-[#eacea9] mb-6">Destinos Exclusivos</h1>
