    ...
    <div className="space-y-8">
      ...
      <section>
        <div className="flex items-center justify-between mb-4">
          ...
          <span className="text-[#d4af37] text-xs font-bold flex items-center gap-1">
            <span className="material-symbols-outlined text-sm">schedule</span> 65 días restantes
          </span>
        </div>
        <div className="group relative aspect-[21/9] rounded-xl overflow-hidden border border-white/5 shadow-2xl">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div className="space-y-2">
              <p className="text-[#d4af37] text-[10px] font-bold uppercase tracking-widest">Reserva Activa • SV-8821</p>
              <h3 className="text-3xl font-bold text-white font-serif leading-none">La Perla Majestuosa - Odisea Mediterránea</h3>
              <div className="flex gap-4 pt-2">
                <span className="text-white/70 text-xs flex items-center gap-1 bg-white/10 px-3 py-1 rounded-full"><span className="material-symbols-outlined text-xs">calendar_today</span> 12 Sept, 2024</span>
                <span className="text-white/70 text-xs flex items-center gap-1 bg-white/10 px-3 py-1 rounded-full"><span className="material-symbols-outlined text-xs">location_on</span> Barcelona a Atenas</span>
              </div>
            </div>
            ...
            >
              Ver Detalles <span className="material-symbols-outlined">chevron_right</span>
            </button>
          </div>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[
            { title: "Escapada por las Islas Griegas", ship: "LJM Royal Sapphire", date: "Junio 2023", img: "https://images.unsplash.com/photo-1533105079780-92b9be482077?auto=format&fit=crop&q=80&w=400" },
            { title: "Sueños Azules del Caribe", ship: "LJM Emerald Horizon", date: "Feb 2023", img: "https://images.unsplash.com/photo-1548574505-5e239809ee19?auto=format&fit=crop&q=80&w=400" }
          ].map((trip, i) => (
            <div key={i} className="bg-[#132345] rounded-xl p-4 border border-white/5 flex gap-4 hover:border-[#eacea9]/30 transition-all cursor-default group/item">
              ...
              <div className="flex-1 flex flex-col justify-center">
                <div className="flex justify-between items-start">
                  ...
                  <span className="text-[8px] font-bold text-green-400 bg-green-400/10 px-1.5 py-0.5 rounded border border-green-400/20">COMPLETADO</span>
                </div>
