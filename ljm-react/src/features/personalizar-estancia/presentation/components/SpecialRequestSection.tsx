...
const SpecialRequestSection = ({ specialRequest, setSpecialRequest }: Props) => (
  <section className="bg-[#e8e9eb] py-24 text-center text-[#0e1a34]">
    <div className="mx-auto max-w-3xl px-6 md:px-10">
      <h2 className="font-display text-4xl md:text-5xl">¿Desea algo más?</h2>
      <p className="mx-auto mt-6 max-w-2xl text-base font-light text-[#0e1a34]/70">
        Nuestro equipo está dedicado a satisfacer hasta el más mínimo capricho. No dude en detallar cualquier
        petición especial.
      </p>
      <textarea
        ...
        placeholder="Escriba aquí sus peticiones especiales..."
