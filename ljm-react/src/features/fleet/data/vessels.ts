...
const buildAccommodations = (prefix: string): VesselAccommodation[] => [
  {
    ...
    mainDesc: "Terraza privada, salon panoramico y acceso reservado a servicios de concierge.",
  ...
  },
  {
    ...
    mainDesc: "Balcon privado, cama king-size y bano revestido con marmol de alto brillo.",
  ...
  },
  {
    ...
    mainDesc: "Configuracion flexible, terraza privada y sistema de entretenimiento a medida.",
...
export const VESSELS: VesselData[] = [
  {
    ...
    description:
      "Nuestro buque insignia ofrece el mas alto nivel de espacio y lujo en el mar, con suites panoramicas y servicio de mayordomo personalizado.",
    length: "362m",
    guests: "5,400",
    ...
    visionTitle: "La Vision: Serenidad en Movimiento",
    visionDescription:
      "The Serenity combina arquitectura naval monumental con interiores silenciosos, pensados para viajeros que quieren amplitud, calma y una experiencia premium sin friccion.",
    visionQuote: "Disenada para convertir cada travesia larga en una residencia flotante.",
    galleryImages: [
      { src: accommodationImages[0], alt: "Suite principal de The Serenity" },
      { src: accommodationImages[1], alt: "Salon privado de The Serenity" },
    ],
    ...
    lifestyleItems: [
      { title: "Gastronomia", description: "Tres restaurantes exclusivos y experiencias privadas al atardecer." },
      { title: "Bienestar", description: "Spa completo, sauna finlandesa y gimnasio panoramico." },
      { title: "Beach Club", description: "Plataformas hidraulicas y salon de observacion subacuatica." },
    ],
  },
  {
    id: "azure",
    ...
    description:
      "Una obra de ingenieria nautica disenada para viajes intimos hacia puertos exclusivos y joyas ocultas del mundo.",
    length: "345m",
    guests: "4,200",
    badge: "Ultra Lujo",
    imageSrc: azureImage,
    ...
    visionTitle: "La Vision: Elegancia Azul",
    visionDescription:
      "The Azure prioriza rutas exclusivas, espacios mas intimos y tecnologia silenciosa para que el viaje se sienta privado incluso en mar abierto.",
    ...
    lifestyleHighlight: {
      icon: "local_bar",
      title: "Salon Azure",
      description: "Cocteleria de autor, musica en vivo y terrazas reservadas para noches privadas.",
    },
    lifestyleTitle: "Elegancia sin Esfuerzo",
    lifestyleItems: [
      { title: "Dining Privado", description: "Menus de temporada con maridajes curados por el sommelier." },
      { title: "Rutas Boutique", description: "Escalas seleccionadas para puertos menos concurridos." },
      { title: "Suites Silenciosas", description: "Aislamiento acustico y terrazas profundas para descanso total." },
    ],
  },
  {
    id: "majestic",
    ...
    description: "Dimensionado para exploracion en alta mar sin comprometer el confort ni la presencia escenica.",
    length: "298m",
    guests: "2,800",
    badge: "Explorador",
    ...
    visionTitle: "La Vision: Exploracion con Carisma",
    visionDescription:
      "The Majestic esta creado para itinerarios activos, desembarcos rapidos y viajeros que quieren lujo con espiritu de expedicion.",
    visionQuote: "La aventura tambien puede llevar lino impecable y cafe perfecto.",
    galleryImages: [
    ...
    lifestyleHighlight: {
      ...
      description: "Briefings diarios, mapas nauticos y especialistas invitados para cada ruta.",
    },
    lifestyleTitle: "Aventura Curada",
    lifestyleItems: [
      { title: "Excursiones", description: "Zodiacs, guias expertos y rutas de naturaleza en grupos reducidos." },
      { title: "Observatorio", description: "Cubiertas abiertas para fotografia, fauna marina y navegacion escenica." },
      { title: "Confort", description: "Camarotes calidos disenados para descansar despues de cada exploracion." },
    ],
  },
  {
    id: "celestial",
    ...
    description: "Disenado para observacion estelar, travesias contemplativas y noches memorables en mar abierto.",
    length: "310m",
    guests: "3,100",
    badge: "Observatorio",
    ...
    visionTitle: "La Vision: Navegar Bajo las Estrellas",
    visionDescription:
      "The Celestial convierte la noche en protagonista con espacios de observacion, iluminacion tenue y experiencias astronomicas guiadas.",
    visionQuote: "Un barco para recordar que el cielo tambien forma parte del itinerario.",
    galleryImages: [
      { src: accommodationImages[2], alt: "Suite de The Celestial" },
      { src: accommodationImages[1], alt: "Salon observatorio de The Celestial" },
    ],
    ...
    lifestyleHighlight: {
      ...
      description: "Sesiones nocturnas de astronomia y cocteles bajo constelaciones.",
    },
    lifestyleTitle: "Noches que Respiran",
    lifestyleItems: [
      { title: "Astronomia", description: "Observatorio con telescopios y charlas guiadas por expertos." },
      { title: "Rituales Nocturnos", description: "Cenas tardias, jazz suave y cubiertas con baja contaminacion luminica." },
  ...
  },
  {
    ...
    description: "Redefine el viaje maritimo sostenible con tecnologia hibrida y una relacion mas consciente con el oceano.",
    length: "330m",
    guests: "3,600",
    badge: "Hibrido",
    ...
    visionTitle: "La Vision: Lujo Responsable",
    visionDescription:
      "The Oceanic apuesta por eficiencia energetica, materiales responsables y experiencias que ponen el oceano en el centro.",
    visionQuote: "Viajar mejor tambien significa dejar una estela mas ligera.",
    galleryImages: [
    ...
    lifestyleHighlight: {
      icon: "eco",
      title: "Blue Lab",
      description: "Programas de educacion marina y experiencias sostenibles durante la travesia.",
    },
    lifestyleTitle: "Consciencia en Alta Mar",
    lifestyleItems: [
      { title: "Tecnologia Hibrida", description: "Operacion optimizada para reducir consumo en rutas seleccionadas." },
      { title: "Cocina Local", description: "Menus con proveedores regionales y pesca responsable." },
      { title: "Ocean Lab", description: "Actividades educativas sobre biodiversidad y conservacion marina." },
    ],
  },
];
