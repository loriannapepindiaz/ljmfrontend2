// features/details_suit/presentation/components/SuiteSummary.tsx
import React from 'react';

const SuiteSummary: React.FC = () => {
  return (
    <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm flex flex-col h-full">
      ...
      <div className="mt-8 pt-8 border-t border-gray-100">
        <div className="flex justify-between items-center mb-4">
          ...
          <span className="text-[10px] bg-green-100 text-green-700 px-3 py-1 rounded-full font-bold uppercase">
            Disponible
          </span>
        </div>
