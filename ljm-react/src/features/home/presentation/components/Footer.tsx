          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-4">
              ...
              <a
                ...
                className="w-10 h-10 rounded-full border border-pearl-beige/30 flex items-center justify-center text-pearl-beige hover:bg-primary hover:text-midnight-blue hover:border-primary transition-colors"
              >
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                ...
                className="bg-white/5 border border-pearl-beige/20 rounded-lg px-4 py-2 text-sm text-pearl-beige placeholder-pearl-beige/30 outline-none focus:ring-primary focus:border-primary focus:bg-white/10 flex-1 transition-all"
              />
              <button className="bg-primary text-midnight-blue p-2 rounded-lg hover:bg-luxury-gold transition-colors">
