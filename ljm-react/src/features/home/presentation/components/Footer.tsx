        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-20">
          ...
          <div>
            ...
            <p className="text-xs text-[#f5f5dc]/50 mb-6 uppercase tracking-widest">
              Recibe ofertas y novedades exclusivas
            </p>
            <div className="flex gap-2">
              <input
                type="email"
                placeholder="Tu correo electrónico"
                className="bg-white/5 border border-[#f5f5dc]/20 rounded-lg px-4 py-2 text-sm text-[#f5f5dc] placeholder-[#f5f5dc]/30 outline-none focus:border-[#eacea9] flex-1 transition-all"
              />
