    ...
    <div className="space-y-10">
      <div className="space-y-4">
        ...
        <h1 className="text-5xl md:text-7xl font-display leading-[1.1] text-white">
          Destino <br />
          <span className="italic text-pearl-beige font-medium">pendiente</span>
        </h1>
      </div>

      <div className="grid grid-cols-2 gap-8 py-8 border-y border-white/10">
        <div>
          <p className="text-[11px] font-bold text-primary tracking-widest uppercase mb-2">Duracion</p>
